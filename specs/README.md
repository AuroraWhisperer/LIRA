...
| ------------------------------------------------ | --------------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------- |
| `specs/desktop-auth-boundaries.md` | Design specification | Implemented | `src/electron/desktop-auth-controller.js`<br>`src/electron/ipc/main-window-ipc.js`<br>`test/desktop-auth-race-electron.test.js`<br>`test/bilibili-cookie-storage.test.js` | 2026-09-25 |
| `specs/games-poll-rating_design.md` | Design specification | In Progress | `src/games/interaction-session-service.js`<br>`src/server/bilibili-client.js`<br>`src/server/overlay-projection.js`<br>`public/pages/admin/toolbox/games.html` | 2026-09-20 |
...
| `specs/server-authoritative-gift-detection_design.md` | Design specification | Implemented | `src/shared/processed-gift-contract.js`<br>`src/bilibili/gift/projection-service.js`<br>`src/electron/remote-gift-controller.js`<br>`src/electron/license/remote-license-client.js`<br>`src/electron/main.js`<br>`test/processed-gift-import.test.js`<br>`test/remote-gift-controller.test.js`<br>`test/remote-license-client.test.js` | 2026-09-13 |
...
| `specs/overtime-gift-sale-refresh_design.md`     | Design specification  | Implemented | `src/bilibili/gift/sale-catalog.js`<br>`src/bilibili/gift/sale-catalog-parser.js`<br>`src/bilibili/gift/hybrid-catalog.js`<br>`src/server/routes/overtime-routes.js`<br>`public/js/admin/gifts/recent.js`<br>`test/gift-sale-catalog.test.js`<br>`test/remote-overtime-catalog.test.js`                                                                                                                                                            | 2026-09-05    |
| `specs/remote-gift-catalog-sync_design.md`       | Design specification  | Implemented | `src/bilibili/gift/remote-catalog-cache.js`<br>`src/bilibili/gift/remote-gift-image-cache.js`<br>`src/bilibili/gift/hybrid-catalog.js`<br>`src/server.js`<br>`public/js/admin/overtime.js`<br>`public/js/admin/gifts/recent.js`<br>`test/remote-catalog-cache.test.js`<br>`test/remote-gift-image-cache.test.js`<br>`test/remote-overtime-catalog.test.js`                                                                                                                                                                                    | 2026-09-05    |
...
| `specs/qixi-que-box-default_design.md`           | Design specification  | Implemented | `src/storage/settings-store.js`<br>`public/js/admin/gifts/recent.js`<br>`test/blind-box-defaults.test.js`                                                                                                                                                                                                                                                                                                    | 2026-09-05    |
