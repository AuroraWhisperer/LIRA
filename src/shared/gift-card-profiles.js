...
function normalizeGiftCardProfilePage(value) {
  if (
    ...
    (value.nextCursor !== null && (typeof value.nextCursor !== 'string' || !eventIdPattern.test(value.nextCursor)))
  )
    throw invalid();
