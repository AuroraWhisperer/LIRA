...
function createGiftStatisticsStore(giftDb) {
  if (!giftDb || typeof giftDb.prepare !== 'function')
    throw new Error('giftDb is required to create GiftStatisticsStore.');
  function deliverOnce(giftEventId) {
...
module.exports = { createGiftStatisticsStore };
