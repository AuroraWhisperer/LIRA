  ...
  return {
    checkIn(input = {}) {
      ...
      try {
          ...
          return formatCheckinRecord(
            {
              ...
              user_name: userName,
              total_days: 1,
              first_checkin_at: atIso,
              last_checkin_at: atIso,
        ...
        const totalDays =
          Math.max(0, Number(row.total_days) || 0) +
          (alreadyCheckedToday ? 0 : 1);
        db.prepare(
          `
        ...
        return formatCheckinRecord(
          {
            ...
            last_checkin_date: alreadyCheckedToday
