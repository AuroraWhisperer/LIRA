...
**LIRA**（**L**ive **I**nteraction & **R**equest **A**ssistant，直播互动与点歌助手）是一款轻量、本地优先的 Bilibili 直播伴侣，主打弹幕点歌、队列与歌库管理、直播悬浮层等功能 —— 无需服务器、无需订阅。它完全运行在主播电脑本地：观众弹幕点歌后自动进入队列，经 OBS / 直播姬网页源展示到直播画面。除点歌外，还集成弹幕互动机器人、AI 弹幕姬、礼物驱动的加班机与全民 K 歌歌词捕捉等工具。
