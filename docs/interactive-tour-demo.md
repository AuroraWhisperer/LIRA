...
1. **欢迎** - 居中显示，说明引导的作用
2. **登录 Bilibili** - 切换到点歌→设置，高亮登录按钮，等待登录完成
3. **填写直播间号** - 高亮输入框，等待用户填写
4. **刷新直播连接** - 高亮右上角"刷新直播"按钮，等待连接成功
5. **导入歌单** - 高亮"导入导出"标签，引导用户了解导入入口
6. **选择音乐平台** - 切换到播放页，高亮平台选择器
7. **查看使用文档** - 切换到百宝箱，高亮使用文档入口
