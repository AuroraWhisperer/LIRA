...
| 萌时钟       | `clockStyle`(`peach`/`starlight`/`soda`/`timeline-horizontal`/`timeline-vertical`)、`clockShowDate`、`clockShowSeconds`、`clockHourFormat`(`12`/`24`)、`clockLabel`；供固定 `/clock` Browser Source 首帧读取                                                                                                                                                                                                         |
