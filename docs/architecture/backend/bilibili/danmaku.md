...
| IdentityCache | TTL **10min**,Map 按 uid 与按小写名双索引;清理定时器 **5min** | `DANMU_MSG`/SC/历史消息的当前房间证据优先于粉丝牌快照和在线榜;无当前房间证据不采纳别家牌;掩码名(含 `**`)优先用缓存全名 | [identity-cache.js:7-44](../../../../src/bilibili/danmaku/identity-cache.js#L7-L44)、[identity-cache.js:89-132](../../../../src/bilibili/danmaku/identity-cache.js#L89-L132)、[message-handlers.js:27-31](../../../../src/bilibili/danmaku/message-handlers.js#L27-L31) |
