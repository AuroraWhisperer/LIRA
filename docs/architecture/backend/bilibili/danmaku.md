...
2. 未开播或 `alwaysHistory` → 启动 HistoryPoller;随后启动 OnlineRankPoller 与 LiveStatusMonitor([danmaku-client.js:168-172](../../../../src/bilibili/danmaku-client.js#L168-L172))。
...
| IdentityCache | TTL **10min**,Map 按 uid 与按小写名双索引;清理定时器 **5min** | `resolve` 合并缓存身份(first non-empty wins),掩码名(含 `**`)优先用缓存全名;在线榜批量 `remember({currentRoom: true})` 时本房间身份优先 | [identity-cache.js:7](../../../../src/bilibili/danmaku/identity-cache.js#L7)、[identity-cache.js:15-44](../../../../src/bilibili/danmaku/identity-cache.js#L15-L44)、[identity-cache.js:89-115](../../../../src/bilibili/danmaku/identity-cache.js#L89-L115)、[message-handlers.js:27-31](../../../../src/bilibili/danmaku/message-handlers.js#L27-L31) |
...
**弹幕**(`handleDanmaku`,[message-handlers.js:75-113](../../../../src/bilibili/danmaku/message-handlers.js#L75-L113)):仅命令文本参与窗口校验与去重;`onMessage` 载荷含 `source:'danmaku'` 与归一化 cmd(`DANMU_MSG` 前缀统一为 `DANMU_MSG`,[message-handlers.js:241-246](../../../../src/bilibili/danmaku/message-handlers.js#L241-L246))。
