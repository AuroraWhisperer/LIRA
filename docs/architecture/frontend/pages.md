...
| `danmaku-feed.js` / `danmaku-message-renderer.js`                           | 可复用弹幕：feed 拥有队列、布局与过期清理；渲染器显式接收文档、样式及图片解析能力，构建安全消息 DOM                                                                    |
