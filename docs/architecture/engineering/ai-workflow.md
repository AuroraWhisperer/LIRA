...
| `ROUTE-GAMES` | Live games sessions, danmaku moves, and game overlays | `src/games/`<br>`src/server/routes/game-routes.js`<br>`public/js/admin/games.js`<br>`public/js/overlays/games.js` | `docs/architecture/backend/api.md`<br>`docs/architecture/backend/ws.md`<br>`docs/architecture/frontend/pages.md` | `src/server/bilibili-client.js`<br>`public/pages/admin/toolbox/games.html`<br>`public/pages/overlays/games.html` | `test/games.test.js`<br>`test/game-routes.test.js`<br>`test/games-overlay.test.js` |
<!-- ROUTE_TABLE_END -->
