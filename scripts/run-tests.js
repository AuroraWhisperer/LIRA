...
const groups = {
  ...
  desktop: ['build-integrity', 'desktop-auth-race-electron', 'desktop-request-auth-electron', 'electron-data-layout', 'local-instance-windows', 'resource-lifecycle-electron'],
  installer: [
    'installer-app-exit',
