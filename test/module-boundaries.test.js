...
const DOMAIN_SQL_LIMITS = {
  ...
  'src/bilibili/gift/query-service.js': 13,
  'src/bilibili/gift/statistics-consumer.js': 6,
  'src/music/requester-target-store.js': 1,
  'src/music/song-service.js': 30,
  'src/overtime/overtime-store.js': 21,
  'src/server/settings-bootstrap.js': 4
};
const EMPTY_CATCH_LIMITS = {
  ...
  'src/server/ws.js': 3,
  'src/server.js': 1,
  'src/storage/database.js': 1,
  'src/storage/settings-store.js': 1,
  'public/js/admin/display.js': 1,
  'public/js/admin/other.js': 2,
  'public/js/admin/overtime.js': 3,
  'public/js/admin/settings.js': 3,
...
test('receiver-aware domain SQL usage is frozen and can only decrease', () => {
  const candidates = listJavaScriptFiles('src')
    .filter(relativePath => !relativePath.startsWith('src/storage/'));
